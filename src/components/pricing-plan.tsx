...
export default function PricingPlan({
  ...
  return (
    <div className="border-border bg-secondary-background flex flex-col justify-between rounded-base border-2 p-5">
      <div>
        <div className="flex items-center justify-between">
          <h3 className="text-2xl font-heading">{planName}</h3>
          {mostPopular && (
            <span className="border-border text-main-foreground rounded-base border-2 bg-main px-2 py-0.5 text-sm">
              Most popular
            </span>
          )}
        </div>
